...
<main class="container-fluid nopadding">
    <div class="content">
        <form method="POST" action="{{ URL::to('/cadastrar') }}" enctype="multipart/form-data">
            {{ csrf_field() }}   
            <div class="row nopadding">
                <div class="col-md-12 register">
                    <label>Nome completo:</label>
                    <input class="form-control" type="text" name="nome" onChange="" placeholder="Digite o nome da pessoa" />
                </div>
            ...
            <div class="row nopadding">
                <div class="col-md-6 register">
                    ...
                    <select class="form-control" name="estadodes" id="estados">
                    </select>
                </div>
            ...
            <div class="row nopadding">
                <div class="col-md-12 register">
                    ...
                    <input class="form-control" type="text" name="endvistoultimo"
            ...
            <div class="row nopadding">
                <div class="col-md-12 register">
                    ...
                    <textarea class="form-control" name="caracteristicasfis"
                        placeholder="Descreva as características físicas da pessoa desaparecida"></textarea>
                </div>
            </div>
            ...
            <div class="row nopadding">
                <div class="col-md-12 register">
                    ...
                    <textarea class="form-control" name="vestimenta"
                        placeholder="Roupas usadas no momento do desaparecimento"></textarea>
                </div>
            </div>
